...
4. **Docs**: If behavior or layout changed, are [docs/8](../../../docs/8.%20architecture.md) / [docs/9](../../../docs/9.%20code-structure.md) and [README](../../../README.md) table updated?
5. **Reference tree**: No required edits under `temp/agno/` for product behavior.
